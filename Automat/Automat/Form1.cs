...
namespace Automat
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void jedan_Click(object sender, EventArgs e)
        {
            ...
            {
                CenaCips.Text = Convert.ToString(Convert.ToDouble(CenaCips) - 0.1 * Convert.ToDouble(CenaCips));
            }
            if (DateTime.Now.DayOfWeek == DayOfWeek.Tuesday)
            {
                CenaPardon.Text = Convert.ToString(Convert.ToDouble(CenaPardon) - 0.1 * Convert.ToDouble(CenaPardon));
            }
            if (DateTime.Now.DayOfWeek == DayOfWeek.Wednesday)
            {
                CenaCoko.Text = Convert.ToString(Convert.ToDouble(CenaCoko) - 0.1 * Convert.ToDouble(CenaCoko));
            }
            if (DateTime.Now.DayOfWeek == DayOfWeek.Thursday)
            {
                CenaVoda.Text = Convert.ToString(Convert.ToDouble(CenaVoda) - 0.1 * Convert.ToDouble(CenaVoda));
            }
            if (DateTime.Now.DayOfWeek == DayOfWeek.Thursday)
            {
                CenaIvi.Text = Convert.ToString(Convert.ToDouble(CenaIvi) - 0.1 * Convert.ToDouble(CenaIvi));
            }
            if ((cipsi1.rok == DateTime.Now.AddDays(-1)) || (cipsi1.rok == DateTime.Now) || (cipsi1.rok == DateTime.Now.AddDays(-2)))
            {
                CenaCips.Text = Convert.ToString(Convert.ToDouble(CenaCips) - 0.2 * Convert.ToDouble(CenaCips));
            }
            if ((girsine1.rok == DateTime.Now.AddDays(-1)) || (girsine1.rok == DateTime.Now) || (girsine1.rok == DateTime.Now.AddDays(-2)))
            {
                CenaPardon.Text = Convert.ToString(Convert.ToDouble(CenaPardon) - 0.2 * Convert.ToDouble(CenaPardon));
            }
            if ((najZelje1.rok == DateTime.Now.AddDays(-1)) || (najZelje1.rok == DateTime.Now) || (najZelje1.rok == DateTime.Now.AddDays(-2)))
            {
                CenaCoko.Text = Convert.ToString(Convert.ToDouble(CenaCoko) - 0.2 * Convert.ToDouble(CenaCoko));
            }
            if ((aqua1.rok == DateTime.Now.AddDays(-1)) || (aqua1.rok == DateTime.Now) || (aqua1.rok == DateTime.Now.AddDays(-2)))
            {
                CenaVoda.Text = Convert.ToString(Convert.ToDouble(CenaVoda) - 0.2 * Convert.ToDouble(CenaVoda));
            }
            if ((sok1.rok == DateTime.Now.AddDays(-1)) || (sok1.rok == DateTime.Now) || (sok1.rok == DateTime.Now.AddDays(-2)))
            {
                CenaIvi.Text = Convert.ToString(Convert.ToDouble(CenaIvi) - 0.2 * Convert.ToDouble(CenaIvi)); 
            }
        }
